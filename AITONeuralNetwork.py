...
nn2 = AITONeuralNetwork(input_layer_size, secret_layer_size, secret_layer_count,
                        generation_count)

nn2 = nn2.load_model()

y2 = nn2.predict([418.504078221616,113.077935462083,45.0876857639276])
...
#
#
# nn.fit(input_x=[[0.1, 0.3, 0.5], [0.6, 0.1, 0.8]],
#        output_y=[[0.9, 0.2, 0.2], [0.3, 0.1, 0.6]], iteration=2, genetic_iteration=1)

# y = nn.predict([0.6, 0.1, 0.8])
# nn.save_model()
